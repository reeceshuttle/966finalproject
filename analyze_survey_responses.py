...
plt.ylim([0,1])
plt.text(0.14, averages[3]+0.01, round(averages[3], 3), fontweight='bold')
plt.text(1.14, averages[4]+0.01, round(averages[4], 3), fontweight='bold')
plt.text(2.14, averages[5]+0.01, round(averages[5], 3), fontweight='bold')
plt.text(-0.08, 0.01, '0.00', fontweight='bold')
plt.text(0.92, 0.01, '0.00', fontweight='bold')
plt.text(1.92, 0.01, '0.00', fontweight='bold')
plt.legend()
plt.show()
